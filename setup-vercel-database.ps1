...
Add-VercelEnv "NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN" "4fba2.firebaseapp.com"
Add-VercelEnv "NEXT_PUBLIC_FIREBASE_PROJECT_ID" "4fba2"
Add-VercelEnv "NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET" "4fba2.firebasestorage.app"
