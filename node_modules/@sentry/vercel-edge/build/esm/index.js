...
function shouldPropagateTraceForUrl(
  ...
  if (cachedDecision !== undefined) {
    DEBUG_BUILD$1 && !cachedDecision && debug.log(NOT_PROPAGATED_MESSAGE, url);
  ...
  DEBUG_BUILD$1 && !decision && debug.log(NOT_PROPAGATED_MESSAGE, url);
  return decision;
}
