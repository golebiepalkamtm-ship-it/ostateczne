...
function startPPRNavigation(navigatedAt, oldUrl, oldCacheNode, oldRouterState, newRouterState, shouldRefreshDynamicData, seedData, seedHead, prefetchData, prefetchHead, isPrefetchHeadPartial, isSamePageNavigation, accumulation) {
...
function createCacheNodeOnNavigation(navigatedAt, newRouterState, oldCacheNode, shouldRefreshDynamicData, seedData, seedHead, prefetchData, prefetchHead, isPrefetchHeadPartial, parentSegmentPath, parentParallelRouteKey, parentNeedsDynamicRequest, accumulation) {
    ...
    oldCacheNode.navigatedAt + _navigatereducer.DYNAMIC_STALETIME_MS > navigatedAt) {
        // Reuse the existing CacheNode
        newCacheNode = reuseDynamicCacheNode(oldCacheNode, newParallelRoutes);
        needsDynamicRequest = false;
    } else if (seedData !== null) {
...
function listenForDynamicRequest(url, nextUrl, task, dynamicRequestTree, // TODO: Rather than pass this into listenForDynamicRequest, we should seed
