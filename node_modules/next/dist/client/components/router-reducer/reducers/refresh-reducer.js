...
function refreshReducer(state, action) {
    ...
    const seedData = null;
    const seedHead = null;
    const result = (0, _navigation.navigateToSeededRoute)(url, currentUrl, state.cache, currentFlightRouterState, seedFlightRouterState, seedRenderedSearch, seedData, seedHead, shouldRefreshDynamicData, nextUrlForRefresh, shouldScroll);
    const mutable = {};
