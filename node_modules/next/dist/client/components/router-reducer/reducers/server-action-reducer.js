...
function serverActionReducer(state, action) {
    ...
    return fetchServerAction(state, nextUrl, action).then(async ({ revalidationKind, actionResult, actionFlightData: flightData, actionFlightDataRenderedSearch: flightDataRenderedSearch, actionFlightDataCouldBeIntercepted: flightDataCouldBeIntercepted, redirectLocation, redirectType })=>{
        ...
        if (redirectLocation !== undefined) {
            ...
            const redirectHref = (0, _createhreffromurl.createHrefFromUrl)(redirectLocation, false);
            const resolvedRedirectType = redirectType || _redirecterror.RedirectType.push;
            const redirectError = (0, _redirect.getRedirectError)((0, _hasbasepath.hasBasePath)(redirectHref) ? (0, _removebasepath.removeBasePath)(redirectHref) : redirectHref, resolvedRedirectType);
        ...
        const shouldRefreshDynamicData = revalidationKind !== _actionrevalidationkind.ActionDidNotRevalidate;
        ...
        if (flightData !== undefined) {
            ...
            normalizedFlightData.isRootRender && flightDataRenderedSearch !== undefined && flightDataCouldBeIntercepted !== undefined) {
                ...
                const result = (0, _navigation.navigateToSeededRoute)(redirectUrl, currentUrl, state.cache, currentFlightRouterState, seedFlightRouterState, seedRenderedSearch, seedData, seedHead, shouldRefreshDynamicData, nextUrl, shouldScroll);
        ...
        const result = (0, _navigation.navigate)(redirectUrl, currentUrl, state.cache, currentFlightRouterState, nextUrl, shouldRefreshDynamicData, shouldScroll, mutable);
        return (0, _navigatereducer.handleNavigationResult)(redirectUrl, state, mutable, pendingPush, result);
    }, (e)=>{
