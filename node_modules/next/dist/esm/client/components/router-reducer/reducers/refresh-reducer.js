...
export function refreshReducer(state, action) {
    ...
    const seedData = null;
    const seedHead = null;
    const result = navigateToSeededRoute(url, currentUrl, state.cache, currentFlightRouterState, seedFlightRouterState, seedRenderedSearch, seedData, seedHead, shouldRefreshDynamicData, nextUrlForRefresh, shouldScroll);
    const mutable = {};
