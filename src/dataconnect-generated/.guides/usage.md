...
```ts
import { useCreatePublicList, useGetPublicLists, useAddMovieToList, useGetUserWatchList } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useGetUserWatchList(getUserWatchListVars);
...
```js
import { createPublicList, getPublicLists, addMovieToList, getUserWatchList } from '@dataconnect/generated';
...
// Operation GetUserWatchList:  For variables, look at type GetUserWatchListVars in ../index.d.ts
